      ...
      <body style={{ background: '#020817', display: 'flex', minHeight: '100vh' }}>
        ...
        >
          ...
          <nav className="flex-1 px-2 py-4 space-y-0.5 overflow-y-auto">
            ...
            <NavItem href="/defense" icon="🛡️" label="Threat Defense" active={pathname === '/defense'} />
            ...
            <NavItem href="/timeline" icon="⏱️" label="Attack Timeline" active={pathname === '/timeline'} />
            <NavItem href="/graph" icon="🕸️" label="Attack Graph" active={pathname === '/graph'} />
          </nav>
